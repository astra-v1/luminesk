...
MESSAGE_CATALOGS: Final[dict[str, dict[str, str]]] = {
	"en": {
		...
		"registry.invalid_payload": "Core registry JSON is invalid.",
		"registry.url_missing": "Core registry URL is not configured. Set {env_var} to a raw GitHub Gist registry JSON URL.",
		"registry.unsupported_provider": "Unsupported core provider type '{provider_type}' in registry JSON.",
		"registry.invalid_core": "Invalid core registry entry: {error}",
		...
		"manager.server_not_found_for_directory": "No server was found for directory '{directory}'. Pass a tag: `nesk start <tag>`.",
		...
		"manager.manual_server_upgrade": "Server '{tag}' has no managed core version metadata. Use `change-core` instead of `upgrade-core`.",
		...
		"manager.docker_started": "[bold]Docker server started[/]",
		...
		"manager.server_must_be_stopped_for_java_change": "Server '{tag}' must be stopped before changing Java.",
		...
		"cli.diagnostic.failure": "[bold]Repository diagnostics found failing sources.[/]",
		"cli.diagnostic.success": "Repository diagnostics finished. All sources responded successfully.",
		"cli.cores.title": "Available Cores",
		"cli.cores.tip": "\n[bold]Tip:[/] use [cyan]nesk diagnostic[/cyan] to verify repository availability.",
		...
		"cli.create.option.java": "Java runtime version or Docker image.",
		...
		"cli.create.prompt.java": "Enter the Java version or Docker image",
		...
		"cli.change_java.option.tag": "Server tag.",
		"cli.change_java.option.java": "New Java runtime version or Docker image.",
		"cli.change_java.prompt.java": "Enter the new Java version or Docker image",
		"cli.change_java.success_title": "[bold]Java changed[/]",
